...
const Footer = () => {
  ...
  return (
    <footer className="bg-charcoal-950 text-white border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 space-y-2.5">
              <a href="tel:+2347031147821" className="flex items-center gap-3 text-sm text-charcoal-400 hover:text-brand-400 transition-colors">
                <Phone className="w-4 h-4" />
                +234 703 114 7821
              </a>
              <a href="mailto:firstchoiceafrovillalimited@gmail.com" className="flex items-center gap-3 text-sm text-charcoal-400 hover:text-brand-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-charcoal-400 hover:text-brand-400 transition-colors flex items-center gap-1.5">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 bg-gradient-to-br from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white rounded-lg transition-colors"
                aria-label="Instagram"
              >
                <FaInstagram className="w-4 h-4" />
              </a>
            </div>
            <p className="text-xs text-charcoal-500 mb-2">Subscribe for updates</p>
            <a
              href="https://formurl.com/to/firstchoice-afro-villa-limited"
              target="_blank"
              rel="noopener noreferrer"
